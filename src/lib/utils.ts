...
const pinyinMap: Record<string, string> = {
  ...
  '荀': 'xun', '羊': 'yang', '惠': 'hui', '甄': 'zhen', '麴': 'qu', '家': 'jia', '封': 'feng',
  ...
  '边': 'bian', '扈': 'hu', '燕': 'yan', '冀': 'ji', '浦': 'pu', '尚': 'shang', '农': 'nong', '温': 'wen',
  ...
  '殳': 'shu', '沃': 'wo', '利': 'li', '蔚': 'wei', '越': 'yue', '夔': 'kui', '隆': 'long', '师': 'shi',
  ...
  '司马': 'simma', '上官': 'shangguan', '欧阳': 'ouyang', '夏侯': 'xiahou', '诸葛': 'zhuge', '闻人': 'wenren',
  '东方': 'dongfang', '赫连': 'helian', '皇甫': 'huangfu', '尉迟': 'yuchi', '公羊': 'gongyang', '澹台': 'tantai',
  '公冶': 'gongye', '宗政': 'zongzheng', '濮阳': 'puyang', '淳于': 'chunyu', '单于': 'chanyu', '太叔': 'taishu',
  '申屠': 'shentou', '公孙': 'gongsun', '轩辕': 'xuanyuan', '令狐': 'linghu', '钟离': 'zhongli', '宇文': 'yuwen',
  '长孙': 'zhangsun', '慕容': 'murong', '鲜于': 'xianyu', '闾丘': 'lvqiu', '司徒': 'situ', '司空': 'sikong',
  '亓官': 'qiguan', '司寇': 'sikou', '仉督': 'zhangdu', '子车': 'ziche', '颛孙': 'zhuansun', '端木': 'duanmu',
  '巫马': 'wuma', '公西': 'gongxi', '漆雕': 'qidiao', '乐正': 'lezheng', '壤驷': 'rangs', '公良': 'gongliang',
  '拓跋': 'tuoba', '夹谷': 'jiagu', '宰父': 'zaifu', '谷梁': 'guliang', '段干': 'duangan', '百里': 'baili',
  '东郭': 'dongguo', '南门': 'nanmen', '呼延': 'huyan', '归海': 'guihai', '羊舌': 'yangshe', '微生': 'weisheng',
  '梁丘': 'liangqiu', '左丘': 'zuoqiu', '东门': 'dongmen', '西门': 'ximen', '南宫': 'nangong', '第五': 'diwu',
  '言': 'yan', '喜': 'xi', '财': 'cai', '磊': 'lei', '娜': 'na', '婷': 'ting',
};
